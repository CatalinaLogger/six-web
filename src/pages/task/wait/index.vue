    ...
    <el-table
      ...
      <el-table-column align="center" label="操作" width="220">
        <template slot-scope="scope">
          ...
          <el-button type="success" size="mini" @click="solveTask(scope.row)">处理任务</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
import { getWaitPage } from '@/api/flow'
...
export default {
  ...
  methods: {
    ...
    _getWaitList() {
      getWaitPage(this.queryModel, this.currentPage, this.pageSize).then(res => {
